 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static ValidarFechas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidarFechas object =
                new ValidarFechas();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validarFechas".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidarFechas)org.example.www.validacion.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
