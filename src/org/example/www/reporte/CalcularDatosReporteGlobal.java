...
/**
 * CalcularDatosReporteGlobal.java
 *
 ...
 */
            ...
            /**
            *  CalcularDatosReporteGlobal bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CalcularDatosReporteGlobal
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":calcularDatosReporteGlobal",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "calcularDatosReporteGlobal",
    ...
    public static class Factory{
        ...
        */
        public static CalcularDatosReporteGlobal parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CalcularDatosReporteGlobal object =
                new CalcularDatosReporteGlobal();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"calcularDatosReporteGlobal".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CalcularDatosReporteGlobal)org.example.www.reporte.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
