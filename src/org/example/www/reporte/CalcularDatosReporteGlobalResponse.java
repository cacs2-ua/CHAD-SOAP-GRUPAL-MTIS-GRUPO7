...
/**
 * CalcularDatosReporteGlobalResponse.java
 *
 ...
 */
            ...
            /**
            *  CalcularDatosReporteGlobalResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CalcularDatosReporteGlobalResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.example.org/Reporte/",
                "calcularDatosReporteGlobalResponse",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":calcularDatosReporteGlobalResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "calcularDatosReporteGlobalResponse",
    ...
    public static class Factory{
        ...
        */
        public static CalcularDatosReporteGlobalResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CalcularDatosReporteGlobalResponse object =
                new CalcularDatosReporteGlobalResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"calcularDatosReporteGlobalResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CalcularDatosReporteGlobalResponse)org.example.www.reporte.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
