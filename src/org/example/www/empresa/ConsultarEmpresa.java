 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":consultarEmpresa",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "consultarEmpresa",
    ...
    public static class Factory{
        ...
        */
        public static ConsultarEmpresa parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConsultarEmpresa object =
                new ConsultarEmpresa();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"consultarEmpresa".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConsultarEmpresa)org.example.www.empresa.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
