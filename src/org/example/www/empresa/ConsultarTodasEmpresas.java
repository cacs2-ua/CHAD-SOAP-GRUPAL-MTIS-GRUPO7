 ...
 */
            ...
            /**
            *  ConsultarTodasEmpresas bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ConsultarTodasEmpresas
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":consultarTodasEmpresas",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "consultarTodasEmpresas",
    ...
    public static class Factory{
        ...
        */
        public static ConsultarTodasEmpresas parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConsultarTodasEmpresas object =
                new ConsultarTodasEmpresas();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"consultarTodasEmpresas".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConsultarTodasEmpresas)org.example.www.empresa.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
