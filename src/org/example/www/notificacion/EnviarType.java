 ...
 */
            ...
            /**
            *  EnviarType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnviarType
    ...
    public static class Factory{
        ...
        */
        public static EnviarType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnviarType object =
                new EnviarType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EnviarType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnviarType)org.example.www.notificacion.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
