 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static Iniciar parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Iniciar object =
                new Iniciar();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"iniciar".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Iniciar)org.example.www.iniciargeneracionreportesestadisticas.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
