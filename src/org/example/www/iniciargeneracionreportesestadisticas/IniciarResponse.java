 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "http://www.example.org/IniciarGeneracionReportesEstadisticas/",
                "iniciarResponse",
                "ns1");
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://www.example.org/IniciarGeneracionReportesEstadisticas/");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":iniciarResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "iniciarResponse",
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://www.example.org/IniciarGeneracionReportesEstadisticas/")){
                return "ns1";
            }
    ...
    public static class Factory{
        ...
        */
        public static IniciarResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IniciarResponse object =
                new IniciarResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"iniciarResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IniciarResponse)org.example.www.iniciargeneracionreportesestadisticas.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
